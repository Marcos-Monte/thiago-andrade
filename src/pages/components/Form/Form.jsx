    ...
    <section className={`${styles.containerForm} limit`}>
      ...
      >
        <fieldset className={styles.group}>
          <legend className={styles.legend}>Manifesto</legend>

          <div className={styles.content}>
            <p>
              Esse espaço é seu, é de todos nós que queremos uma Santos mais
              desenvolvida, sem esquecer de ninguém. Envie sua proposta para a
